...
mon_avg = data.groupby(["Month"]).mean()
...
plot_def ='''{
    ...
    title: {
        text: 'Monthly Average Rating Analysis (2018-2021)'
    },
    subtitle: {
...
def simpleapp() :
    ...
    hc.options.xAxis.categories = list(mon_avg.index)
    hc.options.series[0].data = list(mon_avg['Rating'])
